...
class Behavior {
 ...
 public:
  opendlv::proxy::WheelSpeedRequest getWheelSpeedRequestLeft() noexcept;
  opendlv::proxy::WheelSpeedRequest getWheelSpeedRequestRight() noexcept;
 ...
 private:
  ...
  opendlv::proxy::WheelSpeedRequest m_wheelSpeedRequestLeft;
  opendlv::proxy::WheelSpeedRequest m_wheelSpeedRequestRight;
